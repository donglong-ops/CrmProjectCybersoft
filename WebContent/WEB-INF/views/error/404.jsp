...
<meta charset="utf-8">
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<%= request.getContextPath() %>/static/assets/plugins/images/favicon.png"></
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="<%= request.getContextPath() %>/home" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Về trang chủ</a> </div>
